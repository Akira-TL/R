...
# # plot
# a <- ggraph(mygraph, layout = "dendrogram", circular = TRUE) +
#     geom_conn_bundle(data = get_con(from = from, to = to), alpha = 0.2, colour = "skyblue", tension = 0.9) +
#     geom_node_point(aes(filter = leaf, x = x * 1.05, y = y * 1.05)) +
#     theme_void()

# ggsave("C:/Users/Akira/desktop/edge.png", units = "in", dpi = 300, width = 4, height = 4)
...
ggsave("C:/Users/Akira/desktop/edge.jpg", units = "in", dpi = 300, width = 7, height = 7)
